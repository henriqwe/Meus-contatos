...
describe('sortArrayByKey test', () => {
  it('should return a new array in ascending order by name', () => {
    const array = [
      ...
      },
      {
        id: 7,
        name: 'abraao silva',
        email: '123abraao@yesenia.net',
        phone: '11-263-123-4447'
      },
      {
        id: 3,
  ...
  it('should return a new array in desscending order by name', () => {
    const array = [
      {
        id: 1,
        name: 'Leanne Graham',
    ...
    const newArray = sortArrayByKey({ data: array, key: 'name', asc: false })
    expect(newArray).toEqual([
      {
        id: 1,
        name: 'Leanne Graham',
